...
object Dependencies {
  ...
  lazy val lambdaEvents = "com.amazonaws" % "aws-lambda-java-events" % "3.11.3"
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.21"
  lazy val s3Client = "uk.gov.nationalarchives" %% "da-s3-client" % "0.1.22"
